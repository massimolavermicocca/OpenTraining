...
/**
 * @class ExerciseImageListAdapter
 */
public class ExerciseImageListAdapter extends BaseAdapter{
	...
	static class ImageData implements Parcelable{
		...
		static final Parcelable.Creator<ImageData> CREATOR
			...
			@Override
			public ImageData createFromParcel(Parcel new_parcel) {
				return new ImageData(new_parcel);
			}

			@Override
			public ImageData[] newArray(int new_size) {
				return new ImageData[new_size];
			}
		};
